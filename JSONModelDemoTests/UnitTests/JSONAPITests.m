...
-(void)testGetAPIRequests
{
    ...
    [JSONAPI getWithPath: semaphorKey
              ...
              completion:^(NSDictionary *json, JSONModelError *err) {
                  ...
                  NSURLRequest* request = [NSURLConnection lastRequest];
                  NSString* absString = [request.URL absoluteString];
                  NSString* desiredString = @"http://localhost/test.json/testGetAPIRequests?key2=marin&key1=ma%20rin";
                  NSAssert( [absString isEqualToString: desiredString] , @"URL does not match");
    ...
    [JSONAPI postWithPath: semaphorKey
               ...
               completion:^(NSDictionary *json, JSONModelError *err) {
                  ...
                  NSAssert( [absString isEqualToString: desiredString] , @"URL does not match");
                   ...
                   NSAssert([paramsSent isEqualToString: @"key2=marin&key1=ma%20rin"], @"request body data did not match the post encoded params");
